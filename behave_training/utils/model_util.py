...
def create_model_and_diffusion(
    args, data, ModelClass=MDM, DiffusionClass=LocalMotionDiffusion, diff_steps=1000
):
...
def get_model_args(args, data):
    ...
    if args.dataset in ["behave", "omomo"]:
        ...
        print(f"CREATING MODEL WITH FEATURE DIM: {njoints}")
        nfeats = 1
...
def create_gaussian_diffusion(
    args, diff_steps=1000, DiffusionClass=LocalMotionDiffusion
):
    # default params
