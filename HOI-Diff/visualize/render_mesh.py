...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--obj_mesh_path",
        type=str,
        default="/home/erik/ethz/digital-humans/dex-hoi/HOI-Diff/dataset/behave_t2m/object_mesh/",
    )
    ...
    # object
    npy2obj_object = vis_utils.npy2obj_object(
        npy_path,
        params.obj_mesh_path,
        sample_i,
        rep_i,
    ...
    npy2obj = vis_utils.npy2obj(
        npy_path, sample_i, rep_i, device=params.device, cuda=params.cuda, if_color=True
    )
