...
if __name__ == "__main__":
    ...
    joints_num = 22
    # ds_num = 8
    data_dir = './data/joints_behave'
    data_obj_dir = './data/pose_data_behave/'
    save_dir1 = './data/new_joints_local/'      # './behave/new_joints/'
    save_dir2 = './data/new_joint_vecs_local/'  # './behave/new_joint_vecs/'
